...
namespace EG.WeChat.Web.Controllers
{
    ...
    {
        public static readonly string Token = "iw9flvnfXvrUP";//与微信企业账号后台的Token设置保持一致，区分大小写。
        ...
        public ActionResult Get(string msg_signature = "", string timestamp = "", string nonce = "", string echostr = "")
        {
            ...
            var verifyUrl = new EG.WeChat.Platform.BL.WXCorpBaseService().VerifyWXUrl(msg_signature, timestamp, nonce, echostr);
            if (verifyUrl != null)
            {
