...
namespace EWJ.EOrdering.DA
{
	...
	public sealed class OleDbHelper
	{
        ...
        /// </summary>
        /// <param name="ds"></param>
        /// <param name="oleDBCon"></param>
        /// <param name="commandText"></param>
        public static void DataSetToExcel(DataSet ds,string oleDBCon,string commandText)
        {
            using (OleDbConnection oleConn = new OleDbConnection(oleDBCon))
            {
                OleDbDataAdapter oleAdp = new OleDbDataAdapter();
                OleDbCommand oleCom = new OleDbCommand(commandText, oleConn);
                oleAdp.SelectCommand = oleCom;
