...
namespace TW.Web.Controllers
{
    ...
    {
        public static readonly string Token = "tgor";//与微信企业账号后台的Token设置保持一致，区分大小写。
        public static readonly string EncodingAESKey = "TejKRUa3SvVWVFk4NrTcBlkJ5vJJSvzVrrYXzxAjpjM";//与微信企业账号后台的EncodingAESKey设置保持一致，区分大小写。
        public static readonly string CorpId = "wxe619b76b4aeb0e85";//与微信企业账号后台的EncodingAESKey设置保持一致，区分大小写。
